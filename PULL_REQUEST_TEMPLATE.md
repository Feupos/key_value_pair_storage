...
*Make sure tests pass on all of the [relevant CI workflows](https://github.com/Feupos/key_value_pair_storage/actions).*

### Pull Request Readiness Checklist

See details at [CONTRIBUTING.md](https://github.com/Feupos/key_value_pair_storage/blob/master/CONTRIBUTING.md).
